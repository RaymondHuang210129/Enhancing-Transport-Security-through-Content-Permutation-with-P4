...
action bit0_0_1_action() {
	modify_field(buff0.data, unit11.data0);
	modify_field(unit11.data0, unit10.data0);
	modify_field(unit10.data0, unit9.data0);
	modify_field(unit9.data0, unit8.data0);
	modify_field(unit8.data0, unit7.data0);
	modify_field(unit7.data0, unit6.data0);
	modify_field(unit6.data0, unit5.data0);
	modify_field(unit5.data0, unit4.data0);
	modify_field(unit4.data0, unit3.data0);
	modify_field(unit3.data0, unit2.data0);
	modify_field(unit2.data0, unit1.data0);
	modify_field(unit1.data0, unit0.data0);
}
...
action bit1_0_1_action() {
	modify_field(buff1.data, unit11.data1);
	modify_field(unit11.data1, unit10.data1);
	modify_field(unit10.data1, unit9.data1);
	modify_field(unit9.data1, unit8.data1);
	modify_field(unit8.data1, unit7.data1);
	modify_field(unit7.data1, unit6.data1);
	modify_field(unit6.data1, unit5.data1);
	modify_field(unit5.data1, unit4.data1);
	modify_field(unit4.data1, unit3.data1);
	modify_field(unit3.data1, unit2.data1);
	modify_field(unit2.data1, unit1.data1);
	modify_field(unit1.data1, unit0.data1);
}
...
action bit2_0_1_action() {
	modify_field(buff2.data, unit11.data2);
	modify_field(unit11.data2, unit10.data2);
	modify_field(unit10.data2, unit9.data2);
	modify_field(unit9.data2, unit8.data2);
	modify_field(unit8.data2, unit7.data2);
	modify_field(unit7.data2, unit6.data2);
	modify_field(unit6.data2, unit5.data2);
	modify_field(unit5.data2, unit4.data2);
	modify_field(unit4.data2, unit3.data2);
	modify_field(unit3.data2, unit2.data2);
	modify_field(unit2.data2, unit1.data2);
	modify_field(unit1.data2, unit0.data2);
}
...
action bit3_0_1_action() {
	modify_field(buff3.data, unit11.data3);
	modify_field(unit11.data3, unit10.data3);
	modify_field(unit10.data3, unit9.data3);
	modify_field(unit9.data3, unit8.data3);
	modify_field(unit8.data3, unit7.data3);
	modify_field(unit7.data3, unit6.data3);
	modify_field(unit6.data3, unit5.data3);
	modify_field(unit5.data3, unit4.data3);
	modify_field(unit4.data3, unit3.data3);
	modify_field(unit3.data3, unit2.data3);
	modify_field(unit2.data3, unit1.data3);
	modify_field(unit1.data3, unit0.data3);
}
...
action bit4_0_1_action() {
	modify_field(buff4.data, unit11.data4);
	modify_field(unit11.data4, unit10.data4);
	modify_field(unit10.data4, unit9.data4);
	modify_field(unit9.data4, unit8.data4);
	modify_field(unit8.data4, unit7.data4);
	modify_field(unit7.data4, unit6.data4);
	modify_field(unit6.data4, unit5.data4);
	modify_field(unit5.data4, unit4.data4);
	modify_field(unit4.data4, unit3.data4);
	modify_field(unit3.data4, unit2.data4);
	modify_field(unit2.data4, unit1.data4);
	modify_field(unit1.data4, unit0.data4);
}
...
action bit5_0_1_action() {
	modify_field(buff5.data, unit11.data5);
	modify_field(unit11.data5, unit10.data5);
	modify_field(unit10.data5, unit9.data5);
	modify_field(unit9.data5, unit8.data5);
	modify_field(unit8.data5, unit7.data5);
	modify_field(unit7.data5, unit6.data5);
	modify_field(unit6.data5, unit5.data5);
	modify_field(unit5.data5, unit4.data5);
	modify_field(unit4.data5, unit3.data5);
	modify_field(unit3.data5, unit2.data5);
	modify_field(unit2.data5, unit1.data5);
	modify_field(unit1.data5, unit0.data5);
}
...
action bit6_0_1_action() {
	modify_field(buff6.data, unit11.data6);
	modify_field(unit11.data6, unit10.data6);
	modify_field(unit10.data6, unit9.data6);
	modify_field(unit9.data6, unit8.data6);
	modify_field(unit8.data6, unit7.data6);
	modify_field(unit7.data6, unit6.data6);
	modify_field(unit6.data6, unit5.data6);
	modify_field(unit5.data6, unit4.data6);
	modify_field(unit4.data6, unit3.data6);
	modify_field(unit3.data6, unit2.data6);
	modify_field(unit2.data6, unit1.data6);
	modify_field(unit1.data6, unit0.data6);
}
...
action bit7_0_1_action() {
	modify_field(buff7.data, unit11.data7);
	modify_field(unit11.data7, unit10.data7);
	modify_field(unit10.data7, unit9.data7);
	modify_field(unit9.data7, unit8.data7);
	modify_field(unit8.data7, unit7.data7);
	modify_field(unit7.data7, unit6.data7);
	modify_field(unit6.data7, unit5.data7);
	modify_field(unit5.data7, unit4.data7);
	modify_field(unit4.data7, unit3.data7);
	modify_field(unit3.data7, unit2.data7);
	modify_field(unit2.data7, unit1.data7);
	modify_field(unit1.data7, unit0.data7);
...
action bit7_1_0_action() {
	modify_field(unit0.data7, buff7.data);
...
action bit0_10_1_action() {
	modify_field(unit9.data0, buff0.data);
	swap(unit10.data0, unit11.data0);
}
...
action bit1_10_1_action() {
	modify_field(unit9.data1, buff1.data);
	swap(unit10.data1, unit11.data1);
}
...
action bit2_10_1_action() {
	modify_field(unit9.data2, buff2.data);
	swap(unit10.data2, unit11.data2);
}
...
action bit3_10_1_action() {
	modify_field(unit9.data3, buff3.data);
	swap(unit10.data3, unit11.data3);
}
...
action bit4_10_1_action() {
	modify_field(unit9.data4, buff4.data);
	swap(unit10.data4, unit11.data4);
}
...
action bit5_10_1_action() {
	modify_field(unit9.data5, buff5.data);
	swap(unit10.data5, unit11.data5);
}
...
action bit6_10_1_action() {
	modify_field(unit9.data6, buff6.data);
	swap(unit10.data6, unit11.data6);
}
...
action bit7_10_1_action() {
	modify_field(unit9.data7, buff7.data);
	swap(unit10.data7, unit11.data7);
}
...
action read_key0_action() {
	register_read(key.code0, box00, 0);
}
...
action read_key1_action() {
	register_read(key.code1, box01, 0);
}
...
action read_key2_action() {
	register_read(key.code2, box02, 0);
}
